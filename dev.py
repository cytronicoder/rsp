...
#     dge_file="data/GSM2906447_NeonatalHeart_dge.txt", marker_gene="Actc1", target_cluster=1
# )

coordinates, is_expressing = plot_simulated_cells(
    num_points=1000, expression_percentage=0.25, distribution="biased", sigma=0.3
)
